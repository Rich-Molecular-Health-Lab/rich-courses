...
studbook.tbl <- studbook %>%
  ...
  reactable(
    ...
    groupBy             = "Status",
    columns         = list(
       Status           = colDef(header = tippy("Status", tooltip = "Alive or Deceased"),
                                 maxWidth = 100,
      ...
      Birth_Location    = colDef(header = tippy("Born", tooltip = "Location of birth (captive-born) or capture (wild-born)"),
                                 maxWidth = 200),
      Birth_Date        = colDef(header = tippy("Birthdate", tooltip = "Date of birth (captive-born) or capture (wild-born)"),
                                 cell = color_tiles(
                                   data       = .,
                                ...
                                brighten_text_color = "black",
                                   box_shadow = TRUE,
                                   number_fmt = label_date_short()), maxWidth = 200), 
      Age               = colDef(header = tippy("Age", tooltip = "Now (Alive) or at time of death (Deceased)"),
                                 maxWidth = 50, 
                                 cell = color_tiles(
                                   data       = .,
                                   colors     =  paletteer_d(colors$seq),
      ...
      Last_Date        = colDef(header = tippy("Last Date", tooltip = "Last transfer date (Alive) or date of death (Deceased)"),
                                 cell = color_tiles(
                                   data       = .,
                                   colors     =  paletteer_d(colors$seq),
                                   opacity    = 0.4,
       ...
       Last_Location    = colDef(header = tippy("Last Location", tooltip = "Current institution (Alive) or institution at time of death (Deceased)"), maxWidth = 150),
       ID               = colDef(
      ...
      Sire             = colDef(header = tippy("Father", tooltip = "Studbook ID of Sire (0 if wildborn or unknown)"),
                                 maxWidth = 80,
                              cell = color_tiles(
                                data       = .,
                                colors     = colors$sire,
      ...
      Dam             = colDef(header = tippy("Mother", tooltip = "Studbook ID of Dam (0 if wildborn or unknown)"),
                                 maxWidth = 80,
                              cell = color_tiles(
                                data       = .,
                                colors     = colors$dam,
