...
```{r, include = FALSE}
here::i_am("syllabi/Syllabus_ZooBio.Rmd")

source(here::here("setup/set_paths.R"))
source(here::here(global$setup))
source(here::here(term$agendas))
source(here::here(templates$build_schedule))
source(here::here(templates$pretty_schedules))
source(here::here(templates$syllabus_pretty_tables))
