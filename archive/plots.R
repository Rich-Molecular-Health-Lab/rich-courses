...
#' @param pedigree any pedigree object created by running the ped() function in pedtools
#' @param studbook the tibble containing formatted studbook data imported as a tsv file included in this package (studbook.tsv)
#' @return a list with named colors corresponding to living and deceased males, females, and undetermined sexes that will work with the plot functions in pedtools
#' @rdname color_pals
#' @export
